				...
				<nav className="navbar navbar-expand">
					<div className="collapse navbar-collapse justify-content-between">
						<div className="header-left">
							...
							<div className="header-subleft mx-3 default-market-list-container list-container">
								...
								<div className="ticker-market-list d-flex align-items-center justify-content-between gap-3 list-wrapper" ref={listWrapperRef} onScroll={handleScroll}>
									...
									<div className="t-subheadline-wrapper">
										<div className="t-subheadline1 relative-ticker box-el">
						...
						<div className="navbar-nav header-right">
							...
							<div className="nav-item d-flex align-items-center"><div className="header-right-log header-menu-layout header-theme me-2"><LogoutPage /></div></div>
