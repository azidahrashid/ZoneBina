                  ...
                  <div className="bn-flex">
                    <div className="bn-flex justify-content-center mx-1 icondrop_menu flex-column">
                            ...
                            <DropdownButton
                              align={{lg: 'end'}}
                              as={ButtonGroup}
                              title={<span className="font-i-side trade_icon tradeicon-ticon_165" />}
                              id="bg-nested-dropdown"
                              drop="end"
                              className="moreright-btn bn-flex justify-content-between"
                            >
                            ...
                            <DropdownButton
                              align={{lg: 'end'}}
                              as={ButtonGroup}
                              title={<span className="font-i-side trade_icon tradeicon-ticon_134" />}
                              id="bg-nested-dropdown"
                              drop="end"
                              className="moreright-btn bn-flex justify-content-between"
                            >
                            ...
                            <DropdownButton
                              align={{lg: 'end'}}
                              as={ButtonGroup}
                              title={<span className="font-i-side trade_icon tradeicon-ticon_84" />}
                              id="bg-nested-dropdown"
                              drop="end"
                              className="moreright-btn bn-flex justify-content-between"
                            >
                            ...
                            <DropdownButton
                              align={{lg: 'end'}}
                              as={ButtonGroup}
                              title={<span className="font-i-side trade_icon tradeicon-ticon_57" />}
                              id="bg-nested-dropdown"
                              drop="end"
                              className="moreright-btn bn-flex justify-content-between"
                            >
